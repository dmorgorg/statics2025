...
\begin{tikzpicture}[scale=\scale]
	...
	\draw[very thick, -latex, statsMaroon] (L)--+(0,-1.25)node[below, black, yshift=0.75mm]{$ 5.00\,\textsf{kN}$ };
	\draw[very thick, -latex, statsMaroon] (K)--+(0,-1.25)node[below, black, yshift=0.75mm]{$ 5.00\,\textsf{kN}$ };
