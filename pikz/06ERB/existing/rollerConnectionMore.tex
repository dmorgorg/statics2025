...
\tikz[scale=\scale]{
	...
	\begin{scope}[transform canvas={rotate around =\rrrotate:(OOO)}]
		\fill[top color=mucus, bottom color=mucus!25] ($(OOO)+(-3,-1.5)$) rectangle +(6,-1);
	...
	\fill[white] ($(OOO)+({90+\rrrotate}: -3)+(\rrrotate:0.75)$) -- ++(90+\rrrotate:0.75) -- ++(180+\rrrotate:0.75)-- ++(-90+\rrrotate:0.75);
	\draw[black] ($(OOO)+({90+\rrrotate}: -3)+(\rrrotate:0.75)$) -- ++(90+\rrrotate:0.75) -- ++(180+\rrrotate:0.75);
	}
