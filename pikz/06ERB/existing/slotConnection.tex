...
\tikz[scale=\scale]{
	...
	\begin{scope}[transform canvas={rotate=\rrrotate}]
		\fill[top color=mucus, bottom color=mucus!25] ($(O)+(-3,-0.75)$) rectangle +(6,-1);
	...
	\uncover<2>{
		\fill[white] ($(O)+({90+\rrrotate}: -2.25)+(\rrrotate:1)$) -- ++(90+\rrrotate:1) -- ++(180+\rrrotate:1)-- ++(-90+\rrrotate:1);
		\draw[black, thick] ($(O)+({90+\rrrotate}: -2.25)+(\rrrotate:1)$) -- ++(90+\rrrotate:1) -- ++(180+\rrrotate:1);
		...
		\begin{scope}[xshift=\xshift cm]
			...
			\draw[latex-latex] ($(OO)+(-3,0)$)arc(-180:-90+\rrrotate:3)node[fill=bgcolor, midway, inner sep=0.5mm]{$90\degree\!-\!\theta$};
	...
	\uncover<3>{
		...
		\begin{scope}[xshift=\xshift cm]
			...
			\node at ($(OO)+(45+\rrrotate/2+5: 3.5)$){$90\degree\!-\!\theta$};
			\draw[thin] ($(OO)+(0,1)$)-- +(0,3);
