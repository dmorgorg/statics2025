...
\tikz[scale=\scale]{
	...
	\begin{scope}[transform canvas={rotate around={65.5:(A)}}]
		...
		\shadedraw[top color=Azure4,bottom color=Azure4, middle color=white] ($(A)+(0,0.1875)$) rectangle ($(A)!.4!(B)+(0,-0.1875)$);
		\shadedraw[top color=Honeydew4!75!black,bottom color=Honeydew4!50!black, middle color=Honeydew3] ($(A)+(-.1875,0.25)$) rectangle ($(A)!.15!(B)+(0,-0.25)$);
	...
	\draw ($(O)+(-0.75,0)$) -- +(-1.5,0);
	\draw[latex-latex] ($(O)+(140:2)$)arc(140:180:2)node[midway, fill=white,inner sep=0.5mm]{$38\degree$};
	\draw ($(A)+(0.5,0)$) -- +(1.5,0);
	\draw ($(A)+(65.5:0.5)$) -- +(65.5:1.5);
	\draw[latex-latex] ($(A)+(65.5:1.75)$)arc(65:0:1.75)node[midway, fill=white,inner sep=0.5mm]{$65.5\degree$};
