...
\tikz[scale=\scale]{
	\begin{scope}
		...
		\pgfoonew \Beam =new beam(A,B,gray!25,gray!25, 0.2, 0, 0.25);
		\gettikzxy{(A)}{\ax}{\ay};
		\gettikzxy{(B)}{\bx}{\by};
		\gettikzxy{(C)}{\cx}{\cy};
		...
		\draw[black, thick, -latex] (B)-- +(0,2)node[above right]{$R_B\cos 26.6\degree$ };
		\draw[black, thick, -latex] (B)-- +(-2,0)node[above]{$R_B\sin 26.6\degree$ };
		\draw ($ (A)+(0,-0.75) $) -- (\ax, -4);
		\draw ($ (B)+(0, -0.75) $) -- (\bx, -4);
		\draw ($ (C)+(0,-0.75) $) -- (\cx, -4);
		\draw ($ (B)+(-2.5,0) $) -- (-2.5, \by);
