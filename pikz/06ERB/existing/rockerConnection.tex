...
\tikz[scale=\scale]{
	...
	\begin{scope}[transform canvas={rotate=\rrrotate}]
		\fill[top color=mucus, bottom color=mucus!25] ($(O)+(-3,-1.5)$) rectangle +(6,-1);
	...
	\begin{scope}[transform canvas={rotate around =\rrrotate:(OOO)}]
		\fill[top color=mucus, bottom color=mucus!25] ($(OOO)+(-3,-0.5)$) rectangle +(6,-1);
	...
	\uncover<2>{
		...
		\fill[white] ($(O)+({90+\rrrotate}: -3)+(\rrrotate:0.75)$) -- ++(90+\rrrotate:0.75) -- ++(180+\rrrotate:0.75)-- ++(-90+\rrrotate:0.75);
		\draw[black] ($(O)+({90+\rrrotate}: -3)+(\rrrotate:0.75)$) -- ++(90+\rrrotate:0.75) -- ++(180+\rrrotate:0.75);
		\fill[white] ($(OOO)+({90+\rrrotate}: -2)+(\rrrotate:0.75)$) -- ++(90+\rrrotate:0.75) -- ++(180+\rrrotate:0.75)-- ++(-90+\rrrotate:0.75);
		\draw[black] ($(OOO)+({90+\rrrotate}: -2)+(\rrrotate:0.75)$) -- ++(90+\rrrotate:0.75) -- ++(180+\rrrotate:0.75);
	}
	...
	\uncover<2>{
		...
		\begin{scope}[xshift=\xshift cm]
			...
			\draw[latex-latex] ($(OO)+(-3.5,0)$)arc(-180:-90+\rrrotate:3.5)node[fill=bgcolor, midway, inner sep=0.25mm]{\small $90\degree\!-\!\theta$};
			\draw[thin] ($(OO)+(0,-1)$)-- +(0,-3);
			\draw[latex-latex] ($(OO)+(0,-3.5)$)arc(-90:-90+\rrrotate:3.5)node[fill=bgcolor, midway, inner sep=0.25mm]{\small $\theta$};
