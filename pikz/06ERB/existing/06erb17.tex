...
\tikz[scale=\scale]{
  ...
  \PinnedConnection[-90]{O}{LightYellow3}{black}{0.75}{0.125};
	\PinnedConnection[-90]{B}{LightYellow3}{black}{0.75}{0.125};
  \footnotesize
...
\draw[latex-latex] ($(O)+(0:2.25)$)arc(0:26.6:2.25)node[midway,fill=white, inner sep=0.2mm]{\footnotesize $27.0\degree$};
\draw[latex-latex] ($(O)+(0:2.25)$)arc(0:-40:2.25)node[midway,fill=white, inner sep=0.2mm]{\footnotesize $42.0\degree$};
