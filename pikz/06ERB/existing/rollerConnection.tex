...
\tikz[scale=\scale]{
	...
	\uncover<2>{
		\fill[white] ($(O)+({90+\rrrotate}: -3)+(\rrrotate:1)$) -- ++(90+\rrrotate:1) -- ++(180+\rrrotate:1)-- ++(-90+\rrrotate:1);
		\draw[black, thick] ($(O)+({90+\rrrotate}: -3)+(\rrrotate:1)$) -- ++(90+\rrrotate:1) -- ++(180+\rrrotate:1);
	}
	...
	\uncover<2->{
		...
		\begin{scope}[xshift=\xshift cm]
			...
			\draw[latex-latex] ($(OO)+(-3,0)$)arc(-180:-90+\rrrotate:3)node[fill=bgcolor, midway, inner sep=0.25mm]{\small $90\degree\!-\!\theta$};
