...
\tikz[scale=\scale]{
  ...
  \gettikzxy{(top)}{\tx}{\ty};
	...
	\filldraw[rounded corners=4pt, fill=Cornsilk4!50] (OO)-- ++(158:4)-- ++(0,-2)-- ++(7.4175,0)-- +(0,2) -- cycle;
	...
	\PinnedConnection[22]{A}{DarkOliveGreen4}{black}{0.51}{0.125};
  \footnotesize
  \draw[very thick, saitDeepBlue, -Latex] (B)-- +(0,-1.2)node[below, black]{\scriptsize $8.00\,$kN};
  \draw[very thick, saitDeepBlue, -Latex] (C)-- +(0,-1.475)node[below, black]{\scriptsize $10.0\,$kN};
  \draw[very thick, saitDeepBlue, -Latex] (D)-- +(0,-1.2)node[below, black]{\scriptsize $12.0\,$kN};
  \draw[very thick, saitDeepBlue, -Latex] (D)-- +(-1, 0)node[yshift=0.25cm,xshift=0.375cm, black]{\scriptsize$5.00\,$kN};
