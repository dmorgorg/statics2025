...
\begin{tikzpicture}[scale=\scale]
	...
	\draw[ultra thick, saitMaroon, ->, >=stealth] ($ (Ta)+(0.25,0) $) -- +(1, 0) node[above] {T};
	\draw[ultra thick, saitMaroon, ->, >=stealth] ($ (Tb)+(-0.25,0) $) -- +(-1, 0) node[above] {T};
	\draw[ultra thick, saitMaroon, <-, >=stealth] ($ (Ca)+(0.3,0) $) -- +(1, 0) node[above] {C};
	\draw[ultra thick, saitMaroon, <-, >=stealth] ($ (Cb)+(-0.25,0) $) -- +(-1, 0) node[above] {C};
