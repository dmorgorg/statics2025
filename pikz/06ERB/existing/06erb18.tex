...
\tikz[scale=\scale, line cap=round,decoration={
	...
	% \draw (-13.75,-11) rectangle (2.25,2);
	...
	\pgfoonew \AB=new rrect(A,C,gray!75,gray!75,black, 0.6,0,1.2,.125)
	...
	\draw[-Latex,saitDeepBlue,line width=0.5mm] ($ (DD)+(145:.325)+(225:1.5) $) -- +(225:1.35)node[xshift=-2mm]{\Large $\bm T$};
	...
	\draw[latex-latex] ($(DD)+(2,0.325)$)arc(0:-39:1.85)node[midway, fill=white]{$40\degree $};
	% \draw[latex-latex] ($(DD)+(-2,0.325)$)arc(180:225:1.85)node[midway, fill=white]{$46\degree $};
	\draw[latex-latex] ($(C)+(-2,0.325)$)arc(180:225:2)node[midway, fill=white]{$37\degree $};
	...
	\PinnedConnection[180]{C}{DarkSeaGreen4}{black}{0.75}{0.125}
