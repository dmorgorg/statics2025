...
\tikz[scale=\scale]{
	...
	\def\radii{0}
	\def\extend{0}
	\DL{C}{D}{base}{DarkOliveGreen2}{DarkOliveGreen4}{6}{0.35}{5}
	\DL{D}{E}{base}{DarkOliveGreen2}{DarkOliveGreen4}{8}{0.35}{5}
	

	\fill[AntiqueWhite3] ($ (A)+(0,3.5) $) rectangle ($ (A)+(-1,-1.5) $);
	\draw[thick] ($ (A)+(0,3.5) $) -- +(0, -5);
	\Meme{A}{B}{AntiqueWhite4}{AntiqueWhite2}{black}{0.5}{0}{.5}
