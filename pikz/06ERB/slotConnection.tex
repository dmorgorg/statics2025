...
\tikz[scale=\scale]{
	...
	\uncover<2>{
		...
		\begin{scope}[xshift=\xshift cm]
			...
			\draw[latex-latex] ($(OO)+(-3,0)$)arc(-180:-90+\rrrotate:3)node[fill=white, midway, inner sep=0.5mm]{$90\deg\!-\!\theta$};
			\draw[thin] ($(OO)+(0,-1)$)-- +(0,-3);
			\draw[latex-latex] ($(OO)+(0,-3)$)arc(-90:-90+\rrrotate:3)node[fill=white, midway, inner sep=0.5mm ]{ $\theta$};
	...
	\uncover<3>{
		...
		\begin{scope}[xshift=\xshift cm]
			...
			\draw[thin] ($(OO)+(0,1)$)-- +(0,3);
			\draw[latex-latex] ($(OO)+(0,3.5)$)arc(90:90+\rrrotate:3.5)node[fill=white, midway, inner sep=0.5mm]{ $\theta$};
