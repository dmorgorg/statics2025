...
\begin{tikzpicture}[scale=\scale]
  ...
  \filldraw[fill=Gray!35, draw=black, thick, rounded corners] ($ (C)+(0.25,0) $) rectangle ($ (C)+(-0.25,1.5) $);
	\Meme{A}{C}{Gray!35}{Gray!35}{black}{0.875}{0.1}{0.75}  
  ...
  \draw[thick] ($ (A)+(-0.875,2.5) $) -- ($ (A)+(-0.875,-2.5) $);
	...
	\PC[270]{A}{Gray!50}{black}{0.875}{0.25}
