...
% !TEX root = ../../Beamer/07MoJ/07MoJSxS.tex
...
\begin{tikzpicture}[scale=\scale]
	...
	\footnotesize
	\draw[arrows={Latex[scale=0.75]-Latex[scale=0.75]}, >=stealth] (9.75,0) -- node[fill=white] {$2.50\text{ m}$} (9.75, 2.5);
	\draw[arrows={Latex[scale=0.75]-Latex[scale=0.75]}, >=stealth] (9.75,2.5) -- node[fill=white] {$1.500\text{ m}$} (9.75, 4);
	\draw[arrows={Latex[scale=0.75]-Latex[scale=0.75]}, >=stealth] (9.75,4) -- node[fill=white] {$1.500\text{ m}$}(9.75, 5.5);
	\draw[arrows={Latex[scale=0.75]-Latex[scale=0.75]}, >=stealth] (0,-1) -- node[fill=white] {$3.00\text{ m}$} (3, -1);
	\draw[arrows={Latex[scale=0.75]-Latex[scale=0.75]}, >=stealth] (3,-1) -- node[fill=white] {$3.00\text{ m}$}  (6, -1);
	\draw[arrows={Latex[scale=0.75]-Latex[scale=0.75]}, >=stealth] (6,-1) -- node[fill=white] {$3.00\text{ m}$}  (9, -1);
\end{tikzpicture}
