...
\begin{tikzpicture}[scale=\scale]
	...
	\filldraw[fill=Cornsilk3] ($(DD)+(25:2.5)$)--++(205:2.5)--+(2.25,0);
	\draw[latex-latex] ($(DD)+(25:1.75)$)arc(25:0:1.75)node[fill=Cornsilk3, midway, inner sep=0.5mm]{$25\deg$};
	\fill[Cornsilk3] ($(B)+(-1.25,-0.5)$)rectangle($(B)+(1,-1)$);
	\draw ($(B)+(-1.25,-0.5)$)--($(B)+(1,-0.5)$);

	\Meme{A}{B}{DarkSeaGreen4}{DarkSeaGreen3}{black}{0.3}{0.15}{0.125}
	\Meme{C}{B}{DarkSeaGreen4}{DarkSeaGreen3}{black}{0.3}{0.15}{0.125}
	\Meme{A}{D}{DarkSeaGreen4}{DarkSeaGreen3}{black}{0.3}{0.15}{0.125}
	\Meme{C}{D}{DarkSeaGreen4}{DarkSeaGreen3}{black}{0.3}{0.15}{0.125}
	\Meme{A}{C}{DarkSeaGreen4}{DarkSeaGreen3}{black}{0.3}{0.15}{0.125}

	\draw[ultra thick, SteelBlue4, -Latex] (C)--+(0,-2)node[below,black]{$3.75\,$kN};
	\draw[ultra thick, SteelBlue4, -Latex] (A)--+(2,0)node[right,black]{$2.00\,$kN};
