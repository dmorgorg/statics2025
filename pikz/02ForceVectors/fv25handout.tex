...
\end{scope}
	...
	\draw[line width=2pt, -latex] ($ (C)+(-95:0.1) $) -- +(-95:2.75) node[xshift=-0.25cm, black, below]{$ F_1=2.75 $ kN};
	\draw[line width=2pt, -latex] ($ (C)+(115:.1) $) -- +(115:2.75) node[black, above]{$F$};
	\draw[line width=2pt, -latex] ($ (C)+(205:.1) $) -- +(205:2.75) node[black, left]{$F_2=1.70 $ kN};
