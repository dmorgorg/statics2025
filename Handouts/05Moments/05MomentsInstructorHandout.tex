...
\end{textblock*}
\begin{textblock*}{3.255in}(1in, 7in)
  \centering
  \tikz[scale=\scale]{
    \coordinate (A) at (-1,0);
    \coordinate (B) at (6,0);
    ...
    \draw[very thick, -latex] (Aone)--+(0,-2) node[below] {\small $3.00\,\text{kN}$};
    \draw[very thick, -latex] (Atwo)--+(0,-2.75) node[left] {\small $2.25\,\text{kN}$};
    \draw[very thick, -latex] (Athree)--+(0,-2.25) node[right] {\small $6.00\,\text{kN}$};
