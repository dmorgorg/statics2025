...
\begin{frame}{Bodies}
	...
	\begin{textblock*}{8cm}(3cm, 5cm)	
		...
		\begin{statsbox}{}		
			\centering
			\vspace{-0.25cm}
			\input{../../pikz/05Moments/05Moments01.tex}		
		\end{statsbox}
...
\begin{frame}{Why Two Equations Are Not Enough...}
	...
	\begin{center}
		\tcbox[colback=white,boxsep=0pt,top=15pt,bottom=15pt,left=5pt,right=5pt, enhanced, drop fuzzy shadow,colframe=structure]{
			\input{../../pikz/05Moments/05Moments02.tex}
		}
	\end{center}
...
\begin{frame}{Moments}
	...
	\begin{center}
		\tcb[left=5mm, right=5mm]{
			\centering
			\input{../../pikz/05Moments/05Moments03.tex}
		}
	...
	\cmini[0.8]{
		...
		\mini[0.45]{
			\tcbox[colback=white,boxsep=0pt,top=15pt,bottom=15pt,left=5pt,right=5pt, enhanced, drop fuzzy shadow,colframe=structure]{
				\def\scale{0.3}
				\centering
				\input{../../pikz/05Moments/05Moments04.tex}
			}
		}
		\hfill
		\mini[0.5]{
...
\begin{frame}
	...
	\begin{myexam}{}{}
		\mini[0.45]{
			\centering
			\def\scale{0.6}
			\input{../../pikz/05Moments/05Moments08.tex}
		}
		\hfill
		\mini[0.5]{
...
\begin{frame}
	...
	\begin{myexam}{}{}
		\mini[0.5]{
			\def\scale{0.65}
			\parb
			\input{../../pikz/05Moments/05Moments09.tex}
		}
		\hfill
		\mini[0.4325]{
...
\begin{frame}{}
	...
	\begin{myexer}{}{}
		\def\scale{0.65}
		\input{../../pikz/05Moments/05Moments11.tex}
		\cmini[0.9]{
...
% 	\begin{myexam}{}{}
% 		\def\scale{0.75}
% 		\input{../../pikz/05Moments/05Moments13.tex}
% 		\cmini[0.9]{
...
\begin{frame}
	\cmini{
		\begin{myexam}{}{}
			\centering\parb
			\input{../../pikz/05Moments/05Moments05.tex}
			\parb
...
\begin{frame}
	\cmini[1]{
		\begin{myexam}{}{}
			...
			\ccbox[0.8]{Cornsilk3}{Cornsilk3}{\small (Revisiting {\itshape\rmfamily Example 1}.) Notice that we cannot calculate the moment about $A$ of the force acting on $B$ using horizontal and vertical components because, without the angle at which $AB$ is inclined, we cannot determine $d$ for either the horizontal or the vertical component.} 
			\parm\centering
...
\begin{frame}
	\cmini[1]{
		\begin{myexer}{}{}
			\def\scale{0.8}
			\centering\parb
			\input{../../pikz/05Moments/05Moments06.tex}
			\parm	
			Determine the moment about $A$ of the force acting on $D$. \lb Then determine the moment about $B$ for the same force.
		\end{myexer}
	}
\end{frame}
...
\begin{frame}
	\cmini[1]{
		\begin{myexer}{}{}
			\def\scale{0.8}
			\centering
			\input{../../pikz/05Moments/05Moments07.tex}
			\parm	
			\cmini[0.7]{
				\centering
				Determine the sum of the moments about $A$, about $C$ and about $D$ of the forces shown.
			}
...
\begin{frame}
	...
	\begin{myexam}{}{}
		\def\scale{0.5}
		\begin{center}
			\input{../../pikz/05Moments/05Moments14.tex}
		\end{center}
		\cmini[0.7]{
			\parb
			Considering beam $AB$:
...
\begin{frame}
	...
	\begin{myexer}{}{}
		\def\scale{0.5}
		\begin{center}
			\input{../../pikz/05Moments/05Moments15.tex}
		\end{center}
		\cmini[0.8]{
			\parb
...
\begin{frame}{Distributed Loads}
	...
	\begin{textblock*}{1\textwidth}(1cm, 1.25cm)
		\begin{tcolorbox}[colback=white,colframe=structure,top=0pt, bottom=5pt, enhanced, drop fuzzy shadow]
			\input{../../pikz/05Moments/05dl01.tex}
		\end{tcolorbox}
...
\begin{frame}{Magnitude and Resultant of Distributed Loads}
	...
	\mini[0.47]{
		\begin{statsbox}{Uniformly Distributed Load}
			\begin{center}
				\input{../../pikz/05Moments/05dl02.tex}
			\end{center}
		\end{statsbox}
	}
	\hfill
	\mini[0.48]{
		\begin{statsbox}{Uniformly Varying Load}
			\begin{center}
				\input{../../pikz/05Moments/05dl03.tex}
			\end{center}
		\end{statsbox}
	}
...
\begin{frame}{Distributed Loads}
	\begin{myexam}{}{}
		\centering
		\input{../../pikz/05Moments/05dl04.tex}
		\parm
...
\begin{frame}{Distributed Loads}
	...
	\begin{myexer}{}{}
		...
		\input{../../pikz/05Moments/05Moments16.tex}
		\parm
