...
\begin{frame}{Equilibrium of Concurrent Forces}
	...
	\mini[0.45]{
		\def\scale{0.65}
		\tcb{\input{../../pikz/02ForceVectors/fv27.tex}}
	}
	\hfill
	\mini[0.5]{
		\begin{itemize}
...
\begin{frame}{Force Transmissability}
	...
	\mini[0.31]{
		...
		\begin{statsbox}{}
			\centering
			\input{../../pikz/03EquiConcurrent/03EquiConc01.tex}
		\end{statsbox}		
	}
	\mini[0.31]{
		\centering
		\begin{statsbox}{}
			\centering
			\input{../../pikz/03EquiConcurrent/03EquiConc02.tex}
		\end{statsbox}
	}
	\mini[0.3]{
		\centering
		\begin{statsbox}{}
			\centering
			\input{../../pikz/03EquiConcurrent/03EquiConc03.tex}
		\end{statsbox}
	}
...
\begin{frame}{Force Transmissability and Concurrency}
	...
	\begin{textblock*}{1.0\textwidth}(1cm, 3.25cm)
		\begin{tcolorbox}[colframe=structure, colback=white, left=0pt]
			\centering
			\def\scale{0.5}
			\input{../../pikz/03EquiConcurrent/03EquiConc11}
		\end{tcolorbox}
	\end{textblock*}
...
\begin{frame}{Solving a Concurrent Force System}
	...
	\begin{myexam}[bottom = 0.375cm]{}{}
		\mini[0.4]{
			...
			\only<1-9>{
				\vspace{-0.5cm}
				\input{../../pikz/03EquiConcurrent/fv21Concurrent.tex}
			}
			\only<10->{
				\input{../../pikz/03EquiConcurrent/fv21ConcurrentB.tex}
			}
...
\begin{frame}
	...
	\begin{myexer}{}{}		
		\cmini{
			\centering
			\input{../../pikz/03EquiConcurrent/03EquiConc04.tex}
		}
		\cmini{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}{Pulley Tests}
% 	\tikz{%color
% 		\coordinate (A) at (0,0);
% 		\coordinate (B) at (4,0);
% 		\coordinate (C) at (8,0);

% 		\Pulley {A}{green}{black}{1}{0.125}
% 		\PulleyB {B}{green}{black}{1}{0.125}
% 		\PulleyC {C}{green}{black}{1}{0.5}{1}{0.125}
% 	}

% \end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}{Skywalker Test}
% 	\begin{myexer}{}{}
% 		\centering
% 		\tikz{%color
% 			\coordinate (0) at (0,0);
% 			\coordinate (A) at (0,3);
% 			\coordinate (B) at (3,3);
% 			\Skywalker[0.5]{B}{Maroon}{Maroon}{Black}{Gainsboro!50}{0.5}{.25}	
% 			\Skywalker[-0.5]{A}{Maroon}{Maroon}{Black}{Gainsboro!50}{0.5}{.25}	
% 		}
% 	\end{myexer}
...
% 			\draw[thick] (A)--(J)--(G)--(B);
% 			\Skywalker{G}{Maroon}{Green}{Black}{Gainsboro!50}{.5}{10.25}
% 			\Luke{J}{Green}{Maroon}{Black}{Gainsboro!50}{1}{2.5}
% 		}
% 	\end{myexer}
...
\begin{frame}{Cables and Pulleys}
	...
	\tcb[right=1mm, left=1.75mm]{
		\centering
		\input{../../pikz/03EquiConcurrent/03EquiConc06.tex}
	}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{Cables and Pulleys}
	...
	\tcb[right=1mm, left=1.75mm]{
		\centering
		\input{../../pikz/03EquiConcurrent/03EquiConc07.tex}
	}
\end{frame}
...
\begin{frame}
	\begin{myexer}{}{}
		\cmini[0.9]{
			\centering
			\input{../../pikz/03EquiConcurrent/03EquiConc05}
			\parb
			Cylinder $E$ has a mass of $28$ kg. The system is in equilibrium. Determine the mass of $A$ and the reactions at $C$ and $E$.
