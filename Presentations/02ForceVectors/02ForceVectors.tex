...
\begin{frame}{Component Forces}
	...
	\begin{myexer}{}{}
		...
		% 	\rotatebox[origin=c]{180}{
		% 		\textcolor{gray}{
		% 			($3.50\text{ kN at } 180^\circ, 5.47\text{ kN at} 310^\circ $)
		% 		}
		% 	}
		% \end{center}
	\end{myexer}
...
\begin{frame}
	...
	\cmini[0.9]{
		\begin{myexam}{}{}
			...
			\cmini{
				\raggedright
				The resultant of the forces $F,\;F_1$ and $F_2$ acting upon the eye-bolt is $3.07$ kN at $197^\circ$ measured counter-clockwise from the positive $x$ axis. \parm
