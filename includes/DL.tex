  ...
  \tikzmath{
    ...
    if \forcedown == 1 then {       
        ...
        % in \tikzmath, drawing commands are enclosed in { }; 
        {
          ...
          \end{scope}
          % \draw[\stroke, line width = \llinewidth mm] (\tl)--(\tr);
        };
			};
    } else {
      for \i in {0,...,\spaces} {	
    ...
    if \forcedown == 1 then {
      {\draw[\stroke, line width = \llinewidth mm, line cap = round] (\tl)--(\tr);};
    } else {
       {\draw[\stroke, line width = \llinewidth mm, line cap = round] (\tlx, \by)--(\trx, \by);};
    };
