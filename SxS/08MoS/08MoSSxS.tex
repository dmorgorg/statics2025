...
\documentclass[8pt, xcolor={svgnames, x11names}, professionalfonts]{beamer}
...
\begin{frame}
  ...
  \only<1>{
    \begin{textblock*}{0.9\paperwidth}(0.875cm, 0.5cm)
      \def\scale{0.875}\centering
      \input{../../pikz/08MoS/08MoSSxS01.tex}
    \end{textblock*}
  }
  
  \only<2->{
    \begin{textblock*}{1\paperwidth}(0cm, 0.5cm)
      \def\scale{0.625}\centering
      \input{../../pikz/08MoS/08MoSSxS01b.tex}
    \end{textblock*}
  }

  \only<1>{  
    \begin{textblock*}{8cm}(2.5cm, 6.5cm)
      \normalsize
      \begin{statsbox}[colback=PaleGoldenrod!45]{Method of Sections: Example 1}
        \centering
        Use the method of sections to determine the forces in members $BC$, $BE$ and $EF$.
      \end{statsbox}
    \end{textblock*}
  }
  \only<2->{  
    \begin{textblock*}{6cm}(0.5cm, 5cm)      
      \begin{statsbox}[colback=PaleGoldenrod!45, left=-1mm, height=3.5cm]{}
        \only<2-4>{
          \begin{enumerate}
            \item Draw section $a\mm a$. 
            \item <3-> This section exposes the forces in members $BC$, $BE$ and $EF$
            \item <4-> The right portion of the truss is the easier to analyze --  it does not require solving for, and then using, the reactions at $A$ and $G$. \par({\bf Note} that we can't actually solve for those reactions at this stage: they are statically indeterminate.)
            \suspend           		
          \end{enumerate}
        }
        \only<5->{
          \begin{enumerate}	
            \resume			
            \item Take moments about the joint $B$ to find $F_{EF}$.
            \item <6-> Take moments about the joint $E$ to find $F_{BC}$.
            \item <7-> Notice that $\angle BEF=45\deg$. \lb Sum the $y$-components to find $F_{BE}$.
          \end{enumerate}
        }
      \end{statsbox}
    \end{textblock*}
  ...
  \only<5->{  
    \begin{textblock*}{5.375cm}(7cm, 5cm)      
      \begin{statsbox}[colback=PaleGoldenrod!45, left=-1mm, height=3.5cm, top=0mm]{}
        \begin{align*}
          \only<5-6>{
						\Sigma M_B &= -F_{EF}\cd (1.50\,\textsf{m}) \\
            &\qquad\qquad - (850\,\textsf{N})\cd (3.00\,\textsf{m}) = 0 \\[0.25em]
						\Ra F_{EF} &= -1700\,\textsf{N}\\\\
          }
          \only<6>{
            \Sigma M_E &= F_{BC}\cd(1.50\,\textsf{m}) \\
              &\qquad\qquad - (850\,\textsf{N})\cd (1.50\,\textsf{m}) = 0 \\[0.25em]
            \Ra F_{BC} &= 850\,\textsf{N}\\\\
          }
          \only<7>{
            F_{EF} &= -1700\,\textsf{N}\\
            F_{BC} &= 850\,\textsf{N}\\\\\\
            \Sigma F_y &= -F_{BE}\cd\sin 45\deg - 850\,\textsf{N} = 0\\[0.25em]
    ...
    \only<8>{
			...
			\begin{textblock*}{5cm}(6.75cm,4cm)
					\begin{statsbox}[colback=PaleGoldenrod!45]{The Answers}
						\small
						\begin{align*}
...
\begin{frame}{}
  ...
  \only<1>{  
    \begin{textblock*}{8cm}(2.5cm, 6.75cm)
      \normalsize
      \begin{statsbox}[colback=LightBlue3!35]{Method of Sections: Example 3}
        \centering
        Use the method of sections to determine the forces in members $BC$, $CH$ and $GH$.
      \end{statsbox}
    \end{textblock*}
  ...
  \only<2-5>{  
    \begin{textblock*}{6cm}(0.5cm, 5.625cm)      
      \begin{statsbox}[colback=LightBlue3!35, left=-2mm, right=2mm, height=3.25cm]{}
        \centering
        \begin{itemize}
  ...
  \only<5>{
    \begin{textblock*}{5.25cm}(7cm, 5.625cm)      
      \begin{statsbox}[colback=LightBlue3!35, top=0mm, height=3.25cm]{}
        \begin{align*}
  ...
  \only<6->{  
    \begin{textblock*}{5cm}(0.5cm, 5.625cm)      
      \begin{statsbox}[colback=LightBlue3!35, left=-2mm, right=2mm, height=3.5cm]{}
        \centering        
        \begin{itemize}         
  ...
  \only<6>{
    \begin{textblock*}{6.25cm}(6cm, 5.625cm)      
      \begin{statsbox}[colback=LightBlue3!35, top=0mm, height=3.5cm]{}
        \begin{align*}
  ...
  \only<9->{
    ...
    \begin{textblock*}{5cm}(6.75cm,4cm)
      \begin{statsbox}[colback=LightBlue3!35]{The Answers}
        \small
        \begin{align*}
...
\begin{frame}{}
  ...
  \only<1>{  
    \begin{textblock*}{8cm}(2.5cm, 6.75cm)
      \normalsize
      \begin{statsbox}[colback=NavajoWhite3!45]{Method of Sections: Example 4}
        \centering
  ...
  \only<2-9>{  
    \begin{textblock*}{6cm}(0.5cm, 4.75cm)      
      \begin{statsbox}[colback=NavajoWhite3!45, left=-2mm, right=2mm, height=4.255cm]{}
        \centering
        \begin{itemize}
  ...
  \only<5-7>{
    \begin{textblock*}{5.25cm}(7cm, 4.75cm)      
      \begin{statsbox}[colback=NavajoWhite3!45, top=0mm, height=4.25cm]{}
        \begin{align*}
          \uncover<5->{
  ...
  \only<9>{
    \begin{textblock*}{5.25cm}(7cm, 4.75cm)      
      \begin{statsbox}[colback=NavajoWhite3!45, top=0mm]{}
        \begin{align*}
          \uncover<9->{
  ...
  \only<10->{  
    \begin{textblock*}{6cm}(0.5cm, 4.75cm)      
      \begin{statsbox}[colback=NavajoWhite3!45, left=-2mm, right=2mm, height=4.25cm]{}
        \centering
        \begin{itemize}
  ...
  \only<15>{
    ...
    \begin{textblock*}{5cm}(6.75cm,2.5cm)
      \begin{statsbox}[colback=NavajoWhite3!45,top=0mm]{The Answer}
        \small
        \begin{align*}
...
\begin{frame}{}
  ...
  \only<1>{  
    \begin{textblock*}{9cm}(2cm, 7.75cm)
      \normalsize
      \begin{statsbox}[colback=Snow3!55]{Method of Sections: Example 5}
        \centering
  ...
  \only<2-6>{  
    \begin{textblock*}{5.5cm}(6.75cm, 1.25cm)      
      \begin{statsbox}[colback=Snow3!55, left=-2mm, right=2mm]{Notes:}
        \centering
        \begin{enumerate}
  ...
  \only<7->{  
    \begin{textblock*}{5.5cm}(6.75cm, 1.75cm)      
      \begin{statsbox}[colback=Snow3!55]{}
        \centering        
  ...
  \only<9>{
    ...
    \begin{textblock*}{5cm}(6cm,4.5cm)
      \begin{statsbox}[colback=Snow3!55,top=0mm]{The Answers}
        \small
        \begin{align*}
