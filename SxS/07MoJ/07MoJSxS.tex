...
\begin{frame}
  ...
  \begin{textblock*}{6.25cm}(6.25cm, 0.25cm)
    \input{../../pikz/07MoJ/SxS/07MoJSxS02tikz.tex}
  \end{textblock*}

  \only<1>{  
    \begin{textblock*}{6cm}(0.5cm, 6.5cm)
      \normalsize
      \begin{statsbox}{Method of Joints: Example 2}
  ...
  \only<2-7>{
    \begin{textblock*}{4.5cm}(0.75cm,3.5cm)
      \footnotesize
      \begin{statsbox}[colback=Seashell3!50, coltitle=Seashell3!50]{Find the angles}        
          \begin{align*}
  ...
  \only<8-14>{
    \begin{textblock*}{5.75cm}(0.25cm,0.25cm)
      \begin{statsbox}[colback=Seashell3!50, coltitle=Seashell3!50]{Joint $\bm A$} 
        \centering
        Draw the unknown forces in tension, pointing away from the joint they are acting upon. Then a positive result means the member is in tension and a negative result implies compression.\parm
        \uncover<9->{       
          \tikz[scale=1]{
            \coordinate (A) at (0,0);
            \draw[thick, -latex] (A) -- (36.87:1.75cm) node[above] {$F_{AB}$};
            \draw[very thick,-latex, statsMaroon] (A) -- (-90:1.25cm) node[below] {$\bm{1650}$\,\bf N};
            ...
            \draw[latex-latex] ($ (A)+(1.25,0) $)  arc (0:36.87:1.25) node[fill=Seashell3!50, inner sep = 0.125em] at ($ (A)+(18:1.25) $) {\scriptsize $36.870\deg$};
            \draw[latex-latex] ($ (A)+(1.25,0) $)  arc (0:-51.340:1.25) node[fill=Seashell3!50, inner sep = 0.125em] at ($ (A)+(-26:1.25) $) {\scriptsize $51.340\deg$};
          } % end tikz
        }
        \parm
        \begin{align*}
  ...
  \only<15-17>{
    \begin{textblock*}{5.75cm}(0.25cm,2.25cm)
      \begin{statsbox}[colback=Seashell3!50, coltitle=Seashell3!50]{Joint $\bm B$} 
        \centering             
        \tikz[scale=1]{
          \coordinate (B) at (0,0);
          ...
          \draw[latex-latex] ($ (B)+(-1.25,0) $)  arc (180:216.87:1.25) node[fill=Seashell3!50, inner sep = 0.125em] at ($ (B)+(198:1.25) $) {\scriptsize $36.870\deg $};
  ...
  \only<18-20>{
    \begin{textblock*}{5.75cm}(0.25cm,1.75cm)
      \begin{statsbox}[colback=Seashell3!50, coltitle=Seashell3!50]{Joint $\bm D$} 
        \centering
        ...
        \tikz[scale=1]{
          ...
          \draw[latex-latex] ($ (D)+(-1,0) $)  arc (180:128.66:1) node[fill=Seashell3!50, inner sep = 0.25em] at ($ (D)+(155:1) $) { $51.340\deg$};
          \draw[latex-latex] ($ (D)+(0.875,0) $)  arc (0:63.435:0.875) node[fill=Seashell3!50, inner sep = 0.25em] at ($ (D)+(25:1) $) { $63.435\deg$};
  ...
  \only<21-24>{
    \begin{textblock*}{5.75cm}(0.25cm,.25cm)
      \begin{statsbox}[colback=Seashell3!50, coltitle=Seashell3!50]{Do a calculation check!} 
        \centering
  ...
  \only<25-29>{
    \begin{textblock*}{5.75cm}(0.25cm,.25cm)
      \begin{statsbox}[colback=Seashell3!50, coltitle=Seashell3!50]{Check cont'd} 
        \centering
        ...
        Now, examine joint $C$ for equilibrium:\pars
          \tikz{%
            ...
            \draw[latex-latex] ($ (C)+(-1,0) $)  arc (180:243.44:1) node[fill=Seashell3!50, inner sep = 0.25em] at ($ (C)+(210:1) $) { $63.435\deg$};      
  ...
  \only<30->{
    \begin{textblock*}{5.75cm}(0.25cm,5.5cm)
      \begin{statsbox}[colback=Seashell3!50, coltitle=Seashell3!50]{The Results} 
        \centering
        \begin{align*}
...
\begin{frame}
  ...
  \begin{textblock*}{0.65\linewidth}(0.5cm, 0.25cm)
    \input{../../pikz/07MoJ/SxS/07MoJSxS03tikz.tex}
  \end{textblock*}

\only<1>{  
  \begin{textblock*}{6cm}(5cm, 7.25cm)
    \begin{statsbox}{Method of Joints: Example 3}
...
\only<2-11>{
  \begin{textblock*}{3.75cm}(8.75cm,0.25cm)
    \footnotesize
    \begin{statsbox}{Find the angles}
...
\end{textblock*}
  ...
  \only<34-45>{
    \begin{textblock*}{4.25cm}(8.25cm,0.17cm)    
      \footnotesize
      \begin{statsbox}{Finished \ldots almost}
  ...
  \only<36-37>{
    \begin{textblock*}{4.25cm}(8.25cm,5.875cm)
      \footnotesize
      \begin{statsbox}{But are these correct?}
        \only<36-38>{
  ...
  \only<38-41>{
    \begin{textblock*}{5.75cm}(0.5cm,6cm)   
      \footnotesize
      \begin{statsbox}{Reaction at $\bm A$}       
          \begin{align*}
            % \uncover<38->{
  ...
  \only<40-41>{
    \begin{textblock*}{5.75cm}(6.75cm,6cm)
      \footnotesize
      \begin{statsbox}{Reaction at $\bm B$}       
          \begin{align*}
            % \uncover<38->{
  ...
  \only<42-45>{
    \begin{textblock*}{9cm}(2.25cm,6cm)
      \footnotesize
      \begin{statsbox}{The final check!}
        \vspace{-0.125cm}
        \uncover<42->{         
